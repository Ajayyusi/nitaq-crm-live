...
| NIT-44 | Report consistency | Revenue is computed four ways (cash incl. refunds, cash excl. refunds, accrual, Σ amountPaid); "balance due" in six places; finance "net" omits payouts and supplier bills. *(ACC-24, REL-36)* | See §6. Label each tile's basis or read from the ledger. **Open** |
