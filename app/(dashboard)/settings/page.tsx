  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm text-slate-500">Configure academy details, system preferences, branches, and future role settings.</p>
      </div>
      <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        <h2 className="font-semibold text-slate-900">Settings Workspace</h2>
