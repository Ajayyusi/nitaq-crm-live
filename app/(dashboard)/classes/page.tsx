  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm text-slate-500">Coordinate schedules, class sessions, rooms, attendance, and delivery mode.</p>
      </div>
      <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        <h2 className="font-semibold text-slate-900">Classes Workspace</h2>
